...
import com.example.rakapermanaputra.mynotesapp.db.NoteHelper;
import com.example.rakapermanaputra.mynotesapp.entity.Note;

import java.util.ArrayList;
import java.util.LinkedList;

import static com.example.rakapermanaputra.mynotesapp.FormAddUpdateActivity.REQUEST_UPDATE;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == FormAddUpdateActivity.REQUEST_ADD) {
            ...
            } else if (requestCode == FormAddUpdateActivity.RESULT_DELETE) {
                int position = data.getIntExtra(FormAddUpdateActivity.EXTRA_POSITION, 0);
