...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_TABLE_NOTE = String.format("CREATE TABLE %s"
            + " (%s INTEGER PRIMARY KEY AUTOINCREMEN," +
            " %s TEXT NOT NULL," +
            " %s TEXT NOT NULL," +
            " %s TEXT NOT NULL)",
            DatabaseContact.TABLE_NOTE,
            DatabaseContact.NoteColumns._ID,
            DatabaseContact.NoteColumns.TITLE,
            DatabaseContact.NoteColumns.DESCRIPTION,
            DatabaseContact.NoteColumns.DATE
    );
